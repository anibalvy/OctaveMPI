function [dir_pc, dir_unix] = OctMPI_dir_map(machine_db,dir)
% OctMPI_dir_map  -  Takes care of pc/unix translation of pwd.
%
%  [dir_pc, dir_unix] = OctMPI_dir(machine_db,dir)
%
